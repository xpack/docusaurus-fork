...
export declare const ThemeClassNames: {
    readonly page: {
        ...
        readonly blogAuthorPostListPage: "blog-authors-post-list-page";
        ...
        readonly docsAuthorsListPage: "docs-authors-list-page";
        readonly docsAuthorDocListPage: "docs-authors-doc-list-page";
